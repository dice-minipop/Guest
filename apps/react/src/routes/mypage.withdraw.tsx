    ...
    <div className="min-h-screen bg-dice-white">
      ...
      >
        <section className="space-y-8">
          <h2 className="typo-subtitle2 whitespace-pre-line text-(--dice-black) dark:text-neutral-300">
            OO님과 이별한다니{"\n"}너무 아쉽습니다
          </h2>
        ...
        <section className="space-y-8">
          <h2 className="typo-subtitle2 text-(--dice-black) dark:text-neutral-300">
            탈퇴 전 확인 부탁드립니다
          </h2>
          <p className="typo-body1 text-gray-medium">
        ...
        <section className="space-y-8">
          <h2 className="typo-subtitle3 whitespace-pre-line text-(--dice-black) dark:text-neutral-300">
            더 나은 다이스가 될 수 있도록{"\n"}탈퇴하시는 이유를 알려주시면 감사하겠습니다
          </h2>
          <button
            type="button"
            onClick={() => setReasonSheetOpen(true)}
            className="flex w-full items-center justify-between rounded-lg border border-gray-light bg-dice-white py-12 px-16 text-left typo-body2 text-(--dice-black) transition-colors hover:bg-neutral-100 dark:border-neutral-600 dark:bg-neutral-800 dark:text-neutral-200 dark:hover:bg-neutral-700"
          >
      ...
      <BottomSheet
        ...
        content={
          <div className="overflow-y-auto py-24 px-5 pb-20">
            <h3 className="typo-caption1 mb-3 text-gray-dark dark:text-white">탈퇴 사유</h3>
      ...
      {/* 하단 고정 버튼 */}
      <div
        className="fixed bottom-0 left-0 right-0 z-10 mx-auto max-w-sm gap-12 bg-dice-white px-(--spacing-screen-x) pt-16 dark:bg-neutral-900"
      ...
      >
        <div className="flex gap-12">
          <button
            type="button"
            onClick={handleBack}
            className="min-w-0 flex-1 rounded-lg border border-neutral-300 px-16 py-[15.5px] typo-button1 text-(--dice-black) transition-colors hover:bg-neutral-50 dark:border-neutral-600 dark:text-neutral-200 dark:hover:bg-neutral-800"
          >
            취소
          </button>
          <button
